$(document).ready(function(){
    ...
    $('.search-book-button').click(function(e){
        ...
        swal({
           ...
           text: "En esta pantalla podrás visualizar el promedio de tus indicadores de rendimiento en base a tus calificaciones evaluadas por los docentes, separados por asignatura",  
           closeOnConfirm: false,
           animation: "slide-from-top",
